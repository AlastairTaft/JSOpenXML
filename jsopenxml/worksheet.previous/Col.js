...
goog.provide('sssv.worksheet.Col');
//----------------------------------------------------------------------------//
 ...
 * @param {Element} col
 */
sssv.worksheet.Col = function (col) {
    this.element = col;
 ...
 */
sssv.worksheet.Col.prototype.getRange = function () {
    return this.range_;
};
 ...
 * @returns {goog.math.Range}
 */
sssv.worksheet.Col.prototype.getWidth = function () {
 ...
 */
sssv.worksheet.Col.prototype.getStyleIndex = function () {
 ...
 * @returns {boolean}
 */
sssv.worksheet.Col.prototype.isBestFit = function () {
 ...
 * @returns {boolean}
 */
sssv.worksheet.Col.prototype.isHidden = function () {
